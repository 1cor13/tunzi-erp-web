...
class LaratrustSetupTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('role_company', function (Blueprint $table) {
            ...
            $table->unique(['company_id', 'role_id', 'company_type', 'team_id']);
        });
        ...
        //     $table->unique(['company_id', 'user_id', 'company_type', 'team_id']);
        // });
        ...
        Schema::create('permission_company', function (Blueprint $table) {
            ...
            $table->unique(['company_id', 'permission_id', 'company_type']);
        });
