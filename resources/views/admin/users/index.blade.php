...
<div class="page-header">
    <div class="row">
        <div class="col">
            <h3 class="page-title" style="text-transform: capitalize;">{{ $data->view .' '. $page_name }}</h3>
            <ul class="breadcrumb">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="javascript:void(0);" class="btn add-btn btn-sm @if ($errors->any()) bg-danger shakeButton animated shake @endif mt-1" data-toggle="modal" data-target="#create_user_profile"><i class="fa fa-plus"></i> Add User</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="username" value="{{ old('username') }}" type="text" autocomplete="false">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account_no" value="{{ old('account_no') }}" class="form-control floating">
                                </div>
                            </div>
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    <label>Occupation</label>
                                    <input type="text" name="occupation" value="{{ old('occupation') }}" class="form-control floating">
                                </div>
                            </div>
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    <label>Date Of Birth</label>
                                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth') }}" class="form-control floating">
                                </div>
                            </div>
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    <label>Facebook Profile Link</label>
                                    <input type="text" name="facebook_link" value="{{ old('facebook_link') }}" class="form-control floating">
                                </div>
                            </div>
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    <label>Employee ID</label>
                                    <input type="text" name="twitter_link" value="{{ old('twitter_link') }}" class="form-control floating">
                                </div>
                            </div>
                            <div class="col-sm-6">  
                                <div class="form-group">
                                    <label>LinkedIn Profile Link</label>
                                    <input type="text" name="linkedin_link" value="{{ old('linkedin_link') }}" class="form-control floating">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-12">  
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control floating" name="bio">{{ old('linkedin_link') }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12">  
                                <div class="form-group text-left">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="checkbox" name="receive_messages" checked value="true" class="floating"> Can receive system dashboard messages and notifications
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="checkbox" checked name="account_auth" value="true" class="floating"> Can log into the system and apps
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="checkbox" checked name="email_notifications" value="true" class="floating"> Can receive email messages and notifications from the system
                                        </label>
                                    </div>
                                </div>
                            </div>
            ...
            <table class="table table-striped custom-table data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><br>{{ $user->created_at->toDayDateTimeString() }}</td>
