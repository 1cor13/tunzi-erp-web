			...
			<table class="table table-striped custom-table datatable">
				...
				<tbody>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="profile.html" class="avatar"><img alt="" src="{{ asset('assets/img/profiles/avatar-09.jpg') }}"></a>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="" class="avatar"><img alt="" src="{{ asset('assets/img/profiles/avatar-10.jpg') }}"></a>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="profile.html" class="avatar"><img alt="" src="{{ asset('assets/img/profiles/avatar-05.jpg') }}"></a>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="profile.html" class="avatar"><img alt="" src="{{ asset('assets/img/profiles/avatar-11.jpg') }}"></a>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="" class="avatar"><img alt="" src="{{ asset('assets/img/profiles/avatar-12.jpg') }}"></a>
								<a href="">Jeffrey Warden <span>Web Developer</span></a>
							</h2>
						</td>
						<td>FT-0006</td>
					...
					<tr>
						<td>
							<h2 class="table-avatar">
								<a href="profile.html" class="avatar"><img alt="" src="{{ asset('assets/img/profiles/avatar-13.jpg') }}"></a>
